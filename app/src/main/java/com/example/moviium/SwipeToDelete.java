...
public class SwipeToDelete extends ItemTouchHelper.Callback {
    ...
    protected SwipeToDelete(Context context){
        ...
        deletDraw = ContextCompat.getDrawable(mcontext, R.drawable.ic_action_delete);
    ...
    public void onChildDraw(@NonNull Canvas c, @NonNull RecyclerView recyclerView, @NonNull RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive) {
        ...
        int deleteBotton = deleteTop + myhight;

        deletDraw.setBounds(deleteLeft,deleteTop,deleteRight,deleteBotton);
        deletDraw.draw(c);
